...
var ASM_CONSTS = {
  4558656: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4558717: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4558781: function() {return Module.webglContextAttributes.powerPreference;},  
 4558839: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4558894: function($0) {performance.now = function() { return $0; };},  
 4558942: function($0) {performance.now = function() { return $0; };},  
 4558990: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _GetSheets() {
  		sheetsArr = sheetsDataFetcher.getLoadedSheets();
  		var sheetsStr = null;
  		if (sheetsArr !== null) {
  			sheetsStr = JSON.stringify(sheetsArr);
  		}
  		gameInstance.SendMessage('GoogleSheetsJsInteractions', 'InvokeOnGetSheetsDone', sheetsStr);
  	}
  ...
  function _LoadSheets() {
  		sheetsDataFetcher.loadSheets()
  			.then(sheetsArr => {
  				var sheetsStr = JSON.stringify(sheetsArr);
  				gameInstance.SendMessage('GoogleSheetsJsInteractions', 'InvokeOnLoadSheetsDone', sheetsStr);
  			})
  			.catch(reason => {
  				console.error('Failed to load google sheets:\n', reason);
  				gameInstance.SendMessage('GoogleSheetsJsInteractions', 'InvokeOnLoadSheetsFailed');
  			});
  	}
